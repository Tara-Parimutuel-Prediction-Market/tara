...
// Mock the Telegram environment when running outside of Telegram (e.g. as a standalone PWA).
if (!(await isTMA("complete"))) {
  ...
  console.info(
    "⚠️ Running outside Telegram — environment has been mocked for PWA/browser support.",
  );
}
